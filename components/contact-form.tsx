...
export function ContactForm() {
  ...
  return sent ? <div className="contact-success"><span>✓</span><h2>Message sent.</h2><p>Thanks for reaching out. Our team will get back to you shortly.</p><button className="text-button" type="button" onClick={() => setSent(false)}>Send another</button></div> : (
